...
export const jobs = pgTable("jobs", {
  ...
  company: text("company").notNull().default("Unknown Company"),
  description: text("description").notNull().default("No description provided"),
  requirements: text("requirements").notNull().default("No specific requirements"),
  benefits: text("benefits").notNull().default("Contact for details"),
  ...
  experience: text("experience").notNull().default("Not specified"),
  minSalary: integer("min_salary").notNull().default(0),
  maxSalary: integer("max_salary").notNull().default(0),
  contactEmail: text("contact_email").notNull().default("contact@expertrecruitments.com"),
  applicationDeadline: timestamp("application_deadline").defaultNow(),
  salary: text("salary"),
