          ...
          <div className="grid grid-cols-1 md:grid-cols-7 gap-6 mt-6">
            ...
            <div className="flex flex-col h-full md:col-span-1 md:order-7">
              ...
              <a 
                ...
                className="inline-flex items-center justify-center bg-primary/10 hover:bg-primary/20 text-primary text-xs font-medium px-2.5 py-1.5 rounded-md border border-primary/20 transition-all duration-300 mb-3 shadow-sm w-24"
              >
