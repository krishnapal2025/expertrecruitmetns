            ...
            <Link href="/">
              <div className="flex items-center cursor-pointer">
                ...
                <div className="ml-3 flex flex-col">
                  <span className="text-white font-bold text-xl md:text-2xl tracking-wider uppercase" style={{ letterSpacing: '0.25em' }}>Expert</span>
                ...
                <SheetHeader className="mb-4">
                  <div className="flex flex-col items-center mb-3 space-y-2">
                    ...
                    <div className="flex flex-col items-center">
                      <span className="text-[#5372f1] font-bold text-2xl uppercase tracking-wider" style={{ letterSpacing: '0.25em' }}>Expert</span>
