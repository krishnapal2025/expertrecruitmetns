...
import BlogManagerPage from "@/pages/blog-manager";
...
import AdminUserDebugPage from "@/pages/admin-user-debug";
...
function Router() {
  return (
    <Switch>
      ...
      <AdminProtectedRoute path="/blog-manager" component={BlogManagerPage} />
      ...
      <AdminProtectedRoute path="/admin-debug" component={AdminUserDebugPage} />
