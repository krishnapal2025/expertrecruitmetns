...
export default function SectorsPage() {
  return (
    <>
      <Helmet>
        <title>Industry Sectors | RH Job Portal</title>
      ...
      <div className="bg-primary text-white py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold mb-4">Industry Sectors</h1>
          <p className="text-xl max-w-2xl">
            Explore opportunities across various industries and find the perfect role for your skills and experience.
          </p>
        </div>
      </div>
