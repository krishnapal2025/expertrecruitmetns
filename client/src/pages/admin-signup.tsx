...
export default function AdminSignupPage() {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      role: "admin",
      phoneNumber: "+971 ",
      // Remove userType as it's not part of the schema anymore
    },
  });
  ...
  const onSubmit = (data: FormValues) => {
    ...
    // Show the data we're submitting in console for debugging
    console.log("Form data validated:", data);
    
    // No need to add userType as it will be added on the server
    const submission = data;
    
    console.log("Final submission data:", submission);
    
    // Add a try-catch around the mutation for better error handling
    try {
        ...
        <div className="w-full md:w-1/2 bg-white p-8">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              {/* No need for hidden userType field as it's handled by the server */}
