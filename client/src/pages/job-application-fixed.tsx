                          ...
                          <TabsContent value="experience" className="mt-0">
                            <div className="space-y-6">
                                  ...
                                  >
                                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                      <p className="text-sm text-gray-500">
                                        <span className="font-semibold">Upload additional supporting documents</span>
                                      </p>
                                      {additionalFileName && (
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    <FormLabel>Reference Contacts</FormLabel>
                                    <FormControl>
                                      <Textarea 
                                        className="min-h-[100px]"
                                        placeholder="Names and contact information of professional references (optional)" 
                                        {...field}
                                      />
                                    </FormControl>
                                    <FormMessage />
